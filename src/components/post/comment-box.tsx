...
interface Props {
  ...
  profileMod?: ProfileModel;
}

export function PostCommentBox(props: Props) {
  const { comment, profileMod, loading = false, lastItem = false } = props;
  ...
  const handleSubmitComment = async () => {
    ...
    if (user.did !== "") {
      setIsSubmitting(true);
      await sendPostComment(props.postId, {
                          ...
                          !loading ? (
                            index <= replyPage ? (
                              <Box
                                ...
                                $background={"navy80"}
                              >
                                <div className={"content contentReply"}>
                                  <div className={"header"}>
                                    <div className={"avatar"}>
                                      <Avatar
                                        src={
